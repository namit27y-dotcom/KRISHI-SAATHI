      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-3">
          ...
          >
            ...
            <span className="text-xs font-black truncate block w-full">{mp.allCategories}</span>
            <span className={`text-[10px] block mt-0.5 ${category === "" ? "text-emerald-100" : "text-slate-400"}`}>
              Catalog
            </span>
          </button>
          ...
          {MARKETPLACE_CATEGORIES.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-xs font-black truncate block w-full ${isSelected ? "text-emerald-700" : "text-slate-800"}`}>
                  {localizedCatName}
                </span>
                    ...
                    <div className="bg-slate-50 rounded-xl p-2.5 border border-slate-100 text-[11px] text-slate-600 flex items-center justify-between">
                      <div className="flex items-center gap-1.5 truncate">
                        ...
                        <span className="truncate">
                          {mp.verifiedDealer}: <strong className="text-slate-800 font-bold">{product.sellerName}</strong>
                        </span>
                      </div>
